...
@class MRUNowPlayingLabelView; @class _UIStatusBarCellularSignalView; @class CSAdjunctItemView; @class _UIStatusBarStringView; @class _UIStatusBar; @class _UIBatteryView; @class SBMediaController; @class MRUNowPlayingTransportControlsView; @class MRUNowPlayingControlsView; @class MRUNowPlayingHeaderView; @class _UIStatusBarWifiSignalView; @class _UIStatusBarVisualProvider_Split54; @class _UIStatusBarSignalView; 
...
static __attribute__((constructor)) void _logosLocalCtor_fd5b0d78(int __unused argc, char __unused **argv, char __unused **envp) {
